...
(cl:defmethod cl:initialize-instance :after ((m <FloatArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_aravis-msg:<FloatArray> is deprecated: use camera_aravis-msg:FloatArray instead.")))

(cl:ensure-generic-function 'shape-val :lambda-list '(m))
(cl:defmethod shape-val ((m <FloatArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_aravis-msg:shape-val is deprecated.  Use camera_aravis-msg:shape instead.")
  (shape m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <FloatArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_aravis-msg:data-val is deprecated.  Use camera_aravis-msg:data instead.")
  (data m))
