...
(cl:defmethod cl:initialize-instance :after ((m <ReturnImageFloat-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReturnImageFloat-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optic_flow-srv:<ReturnImageFloat-request> is deprecated: use optic_flow-srv:ReturnImageFloat-request instead.")))

(cl:ensure-generic-function 'request-val :lambda-list '(m))
(cl:defmethod request-val ((m <ReturnImageFloat-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optic_flow-srv:request-val is deprecated.  Use optic_flow-srv:request instead.")
  (request m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReturnImageFloat-request>)))
  ...
  "optic_flow/ReturnImageFloatRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReturnImageFloat-request)))
  "Returns string type for a service object of type 'ReturnImageFloat-request"
  "optic_flow/ReturnImageFloatRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ReturnImageFloat-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReturnImageFloat-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optic_flow-srv:<ReturnImageFloat-response> is deprecated: use optic_flow-srv:ReturnImageFloat-response instead.")))

(cl:ensure-generic-function 'shape-val :lambda-list '(m))
(cl:defmethod shape-val ((m <ReturnImageFloat-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optic_flow-srv:shape-val is deprecated.  Use optic_flow-srv:shape instead.")
  (shape m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <ReturnImageFloat-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optic_flow-srv:data-val is deprecated.  Use optic_flow-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReturnImageFloat-response>)))
  ...
  "optic_flow/ReturnImageFloatResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReturnImageFloat-response)))
  "Returns string type for a service object of type 'ReturnImageFloat-response"
  "optic_flow/ReturnImageFloatResponse")
